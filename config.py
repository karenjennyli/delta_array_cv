...
TOP_A = -40 + 128 #mean threshhold values for A component of dots on top of Delta
TOP_B = 56 + 128 #mean threshhold values for B component of dots on top of Delta 

SIDE_A = 60 + 128
SIDE_B = 40 + 128

THRESH_SIZE = 20 #threshhold for detecting dot color
MIN_VOL = 100 #dots must have this volume in pixels to be considered dots

#Distance in cm between dots on delta
TOP_DOT_DIST = 1.25
SIDE_DOT_DIST = .9

SIDE_CAM_2_DELTA = 14.8 #cm from side camera to Delta center at rest
TOP_CAM_2_DELTA = 25.7 #cm from top camera to Delta center
